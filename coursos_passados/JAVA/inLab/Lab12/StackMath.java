import java.util.*;
/**stack math allows the user to put in an equation, store it in a stack, and then remove it and solve the equation*/
public class StackMath 
{
/**main method includes various data storing units
*@param firstRound
*@param ArrayList equationStuff
*@param Stack myStack
*@param ArrayList charzard
*/
