...
public class DataType
{
    ...
    public String sort()
  {
    ...
    {
      int[] tmp = new int[((LinkedHashSet) data).size()];
      int x = 0;
      Iterator itr = ((LinkedHashSet) data).iterator();
      while (itr.hasNext())
      {
        tmp[x] = (int) itr.next();
        x++;
    ...
    {
      int[] tmp = new int[((LinkedHashMap) data).size()];
      int x = 0;
      Iterator itr = ((LinkedHashMap) data).entrySet().iterator();
      while (itr.hasNext())
      {
        tmp[x] = (int) ((Map.Entry) itr.next()).getValue();
        x++;
