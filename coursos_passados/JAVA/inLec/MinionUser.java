public class MinionUser extends User
{
	...
	public boolean changeOfficeNumber(User targetUser, String username, String password, int newOfficeNumber)//checks username and password first to assign new office number
	{
