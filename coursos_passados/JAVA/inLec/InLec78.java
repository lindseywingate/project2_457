...
public class InLec78
{
          ...
          do
          {
               ...
               switch (input)
               {
                    case 1:
                         ...
                         break;
                    case 2:
                         System.out.println(specificArrayData(usergroups, usernames, passwords, 1));
                         break;
                    case 3:
                         System.out.println(specificArrayData(usergroups, usernames, passwords, 2));
                         break;
                    case 4:
                         System.out.println(specificArrayData(usergroups, usernames, passwords, 3));
                         break;
                    case 5:
                         ...
                         if (validUser(passwords, usernames, password))
                         {
      ...
      */ 
     public static String specificArrayData(ArrayList usergroups, ArrayList usernames, ArrayList passwords, int target)
     {
          String output = "";
          for (int x = 0; x < usernames.size(); x++)
          {
               if (target == usergroups.get(x))
               {
                    output += usernames.get(x) + "\n";
               }
          }
      ...
      */ 
     public static boolean validUser(ArrayList passwords, ArrayList usernames, String password)
     {
