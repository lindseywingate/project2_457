...
public class User
{
     ...
     public User()
     {
          //Not doing anything here as I have defaults listed above for each the User attributes!
          //Setting id number since that has to happen!!!!
          setIDNumber();
     }
      ...
      */ 
     public User(String u, String p, int g, String r, int o) throws SomeonesSettingPasswordsException
     {
          setUsername(u);
          setPassword(p); 
          setGroup(g);
      ...
      * setIDNumber
      * <br><br>
      * Sets the IDNumber of the User.  Is only done by the constructor.
      */ 
      ...
      * @return true if set was succesful, false otherwise
      */ 
     public boolean setPassword(String p) throws SomeonesSettingPasswordsException
     {
          if (passwordSet)
	    {
		//Create an Exception. What kind?
		throw new SomeonesSettingPasswordsException();
      		//return false;
	    }
          password = p;
          passwordSet = true;
      ...
      * setPassword
      * <br><br>
      * Sets the password with admin approval
      * @param p: password, a: admin
      * @return true if set was succesful, false otherwise
      */ 
     public boolean setPassword(String p, AdminUser a)
     {
          if (a.getOnDuty())
          {
               password = p;
